    ...
    for cube in schema.cubes {
        ...
        for dimension in &cube.dimensions {
            ...
            for hierarchy in &dimension.hierarchies {
                let table = &cube.table.name;

                // Get the deepest level for this hierarchy.
                // Time resolution helpers will be based on this level
                let level = &hierarchy.levels[hierarchy.levels.len() - 1];
